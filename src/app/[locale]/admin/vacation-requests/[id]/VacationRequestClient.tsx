      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
        ...
        <div style={{ background: '#fff', boxShadow: '0 4px 32px rgba(0,0,0,0.08)', borderRadius: 16, padding: 24, border: '1px solid #eee', marginBottom: 24 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 24 }}>
            ...
            <p style={{ color: '#000000', marginBottom: 8 }}>Duration: {(() => {
              if (request.durationDays) return `${request.durationDays} day${request.durationDays !== 1 ? 's' : ''}`;
              // Fallback calculation if durationDays is missing
