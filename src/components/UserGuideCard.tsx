  ...
  return (
    <>
      ...
      >
        <div className="mb-6">
          <div
            ...
            style={{
              width: '4rem',
              height: '4rem',
              backgroundColor: 'rgba(216, 177, 27, 0.1)',
              borderRadius: '50%',
              display: 'flex',
              alignItems: 'center',
        ...
        <button
          onClick={openModal}
          className="inline-block bg-gold text-ink px-8 py-3 rounded-lg font-semibold hover:bg-[#C49E15] transition-colors duration-200"
          style={{ 
            display: 'inline-block',
            backgroundColor: '#D8B11B',
            color: '#0A0A0A',
